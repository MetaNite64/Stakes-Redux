...
Card.highlight = function(self, is_h, ...)
  ...
  if (self.config.center.set == "Default" or self.config.center.set == "Enhanced") and self.ability.mf_heavy and self.highlighted ~= pre then
...
G.FUNCS.buy_from_shop = function(e)
  ...
  if card and card:is(Card) then
    if (card.ability.set == "Default" or card.ability.set == "Enhanced") and card.ability.mf_suspend_sticker then
...
-- morefluff sticker playing card locs
